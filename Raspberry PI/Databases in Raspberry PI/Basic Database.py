...
#cursor.execute("INSERT INTO TempData(Temperature,Time,Status) VALUES(99.4,1.20,'Normal')")
#cursor.execute("INSERT INTO TempData(Temperature,Time,Status) VALUES(110.2,1.44,'Abnormal')")
#cursor.execute("INSERT INTO TempData(Temperature,Time,Status) VALUES(125.2,1.45,'Abnormal')")
#cursor.execute("INSERT INTO TempData(Temperature,Time,Status) VALUES(100.2,1.50,'Abnormal')")
var = cursor.execute("SELECT Temperature FROM TempData")
conn.commit()

print(var.description[0][0])
